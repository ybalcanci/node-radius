...
Radius.add_dictionary_relative = function(file) {
  dictionary_locations.push(file);
};

Radius.get_dictionaries = function() {
  return dictionary_locations;
};

Radius.pop_dictionary = function() {
  return dictionary_locations.pop();
};
